...
Config.BillCost = 350                                       -- Price that players are charged for using the hospital check-in system
...
Config.Locations = {                -- Edit the various interaction points for players or create new ones
    ...
    ['beds'] = {
        { coords = vector4(-469.98, -284.46, 35.84, 20),     taken = false, model = 2117668672 },
        { coords = vector4(-462.80, -281.35, 35.84, 19),     taken = false, model = 2117668672 },
        { coords = vector4(-455.07, -278.24, 35.84, 28),     taken = false, model = 2117668672 },
        { coords = vector4(-451.57, -284.69, 35.83, 201),    taken = false, model = 2117668672 },
        { coords = vector4(-460.47, -288.27, 35.83, 207),    taken = false, model = 2117668672 },
        { coords = vector4(-467.00, -291.31, 35.84, 201),    taken = false, model = 2117668672 },
        --- paleto
    ...
    ['hospital'] = {
        {
            ...
            ['location'] = vector3(-435.83, -325.86, 34.91),
            ['beds'] = {
                { coords = vector4(-469.98, -284.46, 35.84, 20),    taken = false, model = 2117668672 },
                { coords = vector4(-462.80, -281.35, 35.84, 19),    taken = false, model = 2117668672 },
                { coords = vector4(-455.07, -278.24, 35.84, 28),    taken = false, model = 2117668672 },
    ...
    ['stations'] = {
        { label = Lang:t('info.pb_hospital'), coords = vector3(-435.83, -325.86, 34.91) }
    }
}
