...
-- Define particle effect settings
local PTFX_DICT, PTFX_ASSET, LOOP_AMOUNT, PTFX_DURATION
PTFX_DICT = 'core'
PTFX_ASSET = 'ent_dst_elec_fire_sp' -- Particle effect for electricity
LOOP_AMOUNT = 25
PTFX_DURATION = 1000

-- Function to apply the particle effect
...
if Config.NoClipType == 1 then
    function toggleFreecam(enabled, isInVis)
        ...
        if enabled then
            ...
            createPlayerModePtfxLoop(ped) -- Trigger particle effect when NoClip is enabled
        end
        ...
        local function disableNoClip()
            ...
            createPlayerModePtfxLoop(ped) -- Trigger particle effect when NoClip is disabled
        end
