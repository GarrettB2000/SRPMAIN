...
AdminPanel.ResetReportsList = function() {
    ...
    // Ensure ReportsList is defined and is an array
    if (Array.isArray(AdminPanel.ReportsList)) {
        ...
        console.error("AdminPanel.ReportsList is not an array or is undefined");
    }
...
AdminPanel.ResetAdminChat = function() {
    ...
    // Ensure AdminChat is defined and is an array
    if (Array.isArray(AdminPanel.AdminChat)) {
        ...
        console.error("AdminPanel.AdminChat is not an array or is undefined");
    }
