...
RegisterNetEvent('qb-bossmenu:client:ManageEmployee', function(data)
    ...
    EmployeeMenu[#EmployeeMenu + 1] = {
        ...
        params = {
            isServer = true,
            event = "srp_multijob:server:FireEmployee",
            args = {
...
RegisterNetEvent('qb-bossmenu:client:Stash', function()
    ...
    TriggerServerEvent("ox_inventory:openInventory", 'stash', stashName, {
        slots = 100,
        weight = 4000000
    })

    -- Set the current stash for the client (if necessary, depending on your system)
    TriggerEvent("ox_inventory:setCurrentStash", stashName)
end)
