...
Config.RequireJob = true -- Do you want this to be only for players with a specific job? (True if yes, false if no. You must set framework to 'esx' or 'qbcore' for this feature)
Config.JobName = 'tow' -- The job name required if Config.JobLock is true
Config.StartJobPedModel = 'a_m_m_business_01' -- The model of the ped that starts the job
Config.StartJobLocation = vector3(410.72, -1658.98, 29.29) -- The location at which you start the job (and the map blip location)
Config.DeliverLocation = vector3(401.13, -1632.48, 28.29) -- The location at which you deliver vehicles
...
Config.StartJobPedHeading = 0 -- The direction at which the start job ped is facing
Config.SpawnTruckLocation = vector3(408.56, -1646.63, 28.29) -- The location at which the tow truck spawns to start the job
Config.SpawnTruckHeading = 0 -- The direction the tow truck being spawned is facing
...
--[[ Pay Conigs ]]
Config.PayPerDelivery = 625 -- How much the player is paid per delivery completed
...
Config.MinPayPerDelivery = 437.5 -- If Config.RandomPayPerDelivery = true then what is the minimum pay? (If RandomPay false, ignore this)
Config.MaxPayPerDelivery = 1185 -- If Config.RandomPayPerDelivery = true then what is the maxmimum pay? (If RandomPay false, ignore this)
