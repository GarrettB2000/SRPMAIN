Config = {
	...
	Harness = {
		...
		minimumSeatBeltSpeed = 240, -- Minimuim speed for ejecting with a seatbelt attached
	...
	Emergency = {
		...
		Locations = {
			...
			{ coords = vector4(1809.36, 3686.37, 33.97, 298), prop = true }, -- BSCO PARKING LOT
		},
	...
	NOS = { -- NOS STUF
		...
		FlameDis = 200.0,			-- How far from the vehicle players can see Boost flames
