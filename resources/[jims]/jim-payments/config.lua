...
Config = {
	...
	CashInLocation = vector4(0,0,0,0), -- Default Third Window along in Pacific Bank
	...
	Jobs = {
		['staff'] = { MinAmountforTicket = 50, PayPerTicket = 50, Commission = 0.10, gang = true, }, -- Example of a gang being supported
	},
	...
	----------------------------------- USE THIS - KAIDE
	-- The /invoice command requires specific jobs to be set
	-- No tickets for these, it's just commission (0.25 = 25%)
	FineJobs = {
		['police'] = { Commission = 0.40, },
		['bcso'] = { Commission = 0.40, },
		['sasp'] = { Commission = 0.40, },
		['doj'] = { Commission = 0.50, },
		['casino'] = { Commission = 0.25, },
		['ambulance'] = { Commission = 0.40, },
		['gunstorelegion'] = { Commission = 0.25, },
		['gunshop8194'] = { Commission = 0.30, },
		['gunshopvinewood'] = { Commission = 0.25, },
		['gunshop8140'] = { Commission = 0.40, },
		['gunstore9275'] = { Commission = 0.25, },
		['bestbuds'] = { Commission = 0.25, },
		['ottos'] = { Commission = 0.25, },
		['redline'] = { Commission = 0.25, },
		['whitewidow'] = { Commission = 0.15, },
		['lscustoms'] = { Commission = 0.25, },
		['tunershop'] = { Commission = 0.25, },
		['vapeshop'] = { Commission = 0.25, },
		['legionbuds'] = { Commission = 0.25, },
		['catcafe'] = { Commission = 0.25, },
		['pizzathis'] = { Commission = 0.25, },
		['pharmacy'] = { Commission = 0.25, },
		['sinmechanic'] = { Commission = 0.25, },
		['bennys'] = { Commission = 0.25, },
		['cloudnine'] = { Commission = 0.50, },
		['pawnshop'] = { Commission = 0.25, },
		['lawfirm'] = { Commission = 0.25, },
		['vanilla'] = { Commission = 0.50, },
		['clownsecurity'] = { Commission = 0.25, },
		['beanmachine'] = { Commission = 0.25, },
		['bakery'] = { Commission = 0.25, },
		['popsdiner'] = { Commission = 0.25, },
		['henhouse'] = { Commission = 0.25, },
		['smoking'] = { Commission = 0.25, },
		['gunshop3018'] = { Commission = 0.25, },
		['popeyes'] = { Commission = 0.25, },
		['beharper'] = { Commission = 0.30, },
		['bahama'] = { Commission = 0.25, },
		['paletodealer'] = { Commission = 0.25, },
		['gunshoppaleto'] = { Commission = 0.25, },
		['plasmakart'] = { Commission = 0.25, },
		['snautos'] = { Commission = 0.25, },
		['burgershot'] = { Commission = 0.50, },
		['gunshop7174'] = { Commission = 0.25, },
		['airdealer'] = { Commission = 0.25, },
		['boxing'] = { Commission = 0.25, },
		['innout'] = { Commission = 0.25, },
		['digitalden'] = { Commission = 0.25, },
		['arcadehouse'] = { Commission = 0.25, },
		['comic'] = { Commission = 0.25, },
		['emeraldbar'] = { Commission = 0.25, },
		['cypress'] = { Commission = 0.25, },
		['recovery596'] = { Commission = 0.25, },
		['recovery697'] = { Commission = 0.25, },
		['recovery753'] = { Commission = 0.25, },
		['recovery762'] = { Commission = 0.25, },
		['cookies'] = { Commission = 0.25, },
		['taxi'] = { Commission = 0.25, },
	},		
