...
Config.BlipsCommand = false -- command to toggle blips (set to false to disable)
Config.Command = false -- command to place spike strip, set to false to disable
...
Config.Job = {}
Config.Job.RequirePlace = false -- require job to place a spike strip?
Config.Job.RequireRemove = false -- require job to remove placed spike strips?
