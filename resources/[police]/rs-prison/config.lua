...
Config.Outfits = { -- Set their prion outfits when they go to jail
    ...
    male = {
        ...
        jacket = { item = 381, texture = 0 },
        pants = { item = 171, texture = 0 },
        shoes = { item = 16, texture = 0 },
        accessories = { item = 0, texture = 0 },
    },
    female = {
        mask = { item = 0, texture = 0 },
        arms = { item = 176, texture = 0 },
        shirt = { item = 246, texture = 0 },
        jacket = { item = 661, texture = 0 },
        pants = { item = 27, texture = 7 },
        shoes = { item = 88, texture = 0 },
        accessories = { item = 0, texture = 0 },
    },
}
