...
---------------MAIN SIREN SETTINGS-----------------
main_siren_settings_masterswitch = true -- false
--	Enables users to rename siren tones, change siren options. (Cycle / Button) 
park_kill_masterswitch = true -- false?
...
airhorn_interrupt_masterswitch = true -- false
...
main_siren_set_register_keys_set_defaults = false
