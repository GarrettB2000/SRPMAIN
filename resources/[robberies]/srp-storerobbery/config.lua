...
Config.PoliceJobType = "police"                    -- Name of job type used by your server - NOTE: Only used if "Config.UsePoliceName = false"
...
Config.minRegisterEarn = 1000                   -- Minimum amount earnt from stealing from a cash register
Config.maxRegisterEarn = 2500                   -- Maximum amount earnt from stealing from a cash register

Config.RegisterTime = 28                        -- progressBar time it takes for player to rob cash register after lockpicking (in seconds)
...
Config.SafeReqItem = "usb_green"                     -- Change to any item you want (needs to be in qb-core/shared/items.lua)

Config.SafeReturn = "cash"                -- Set to "dirtymoney", "markedbills" or "cash" to alter the reward given.

Config.minSafeEarn = 10000                       -- Minimum amount earnt from stealing from a safe (in dirtymoney)
...
Config.RareItem1Chance = 2                     -- Percentage chance to obtain the rare item drop from robbing a safe.
...
Config.RareItem2Chance = 2                    -- Percentage chance to obtain the rare item drop from robbing a safe.
...
Config.AlcoholReturn = "cash"             -- Set to "dirtymoney", "markedbills" or "cash" to alter the reward given.

Config.AlcoholminSafeEarn = 12000                -- Minimum amount earnt from stealing from a safe (in dirtymoney)
Config.AlcoholmaxSafeEarn = 18000               -- Maximum amount earnt from stealing from a safe (in dirtymoney)
...
Config.AlcoholRareItem1Chance = 0              -- Percentage chance to obtain the rare item drop from robbing a safe.
...
Config.AlcoholRareItem2Chance = 0              -- Percentage chance to obtain the rare item drop from robbing a safe.
