Config = {}
Config.RepChance = 65
Config.RepRewardonTV = 2
Config.NotorietyRewardonTV = 2
...
Config.AdvancedLockpickName = 'advancedlockpick'
...
Config.SafeRewards = { -- It will pick a random combination from this table. Price: 0 keep it zero
    ...
    [3] = {
        ...
        {name = "goldchain", price = 0, amount = math.random(1,2), info = {}, type = "item", slot = 2},
    },
    [4] = {
        {name = "iphone", price = 0, amount = math.random(1,3), info = {}, type = "item", slot = 1},
        {name = "dirtymoney", price = 0, amount = math.random(4000,8000), info = {}, type = "item", slot = 2},
        {name = "rolex", price = 0, amount = math.random(1,2), info = {}, type = "item", slot = 3},
        {name = "samsungphone", price = 0, amount = math.random(1,3), info = {}, type = "item", slot = 4},
        {name = "goldchain", price = 0, amount = math.random(1,2), info = {}, type = "item", slot = 5},
    },
    [5] = {
        {name = "dirtymoney", price = 0, amount = math.random(2000,5000), info = {}, type = "item", slot = 1},
        {name = "rolex", price = 0, amount = math.random(1,2), info = {}, type = "item", slot = 2},
        {name = "samsungphone", price = 0, amount = math.random(1,3), info = {}, type = "item", slot = 3},
        {name = "goldchain", price = 0, amount = math.random(1,3), info = {}, type = "item", slot = 4},
        {name = "diamond_ring", price = 0, amount = math.random(1,2), info = {}, type = "item", slot = 5},
    },
}
...
Config.ItemsReward = { -- It will pick a random combination from this table.
    ...
    [4] = {{
        type = 'item',
        itemName = 'ammo-9',
        itemQty = math.random(10, 20)
    }},
    [5] = {{
        type = 'item',
        itemName = 'dirtymoney',
        itemQty = math.random(3000, 5000)
    }},
    [6] = {{
        type = 'item',
        itemName = 'iphone',
