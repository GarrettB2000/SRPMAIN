...
Config.CoolDown = 0      -- How long people must wait before starting another job (in minutes)

Config.EnableDog = false    -- For testing purposes only inache da e true hehe

Config.EnablePolice = true -- Whether to check for police online or not
...
Config.Locale = {
    -- Notifications
    ["Reminder"]         = "Remove parts from the vehicle then get back into it to crush it!",
    ["FarAway"]          = "You have moved too far away from the car. It will be sent for destruction!",
    ["CoolDown"]         = "Wait a bit, will you?",
    ["JobActive"]        = "You already have an active task!",
    ...
    ["notInaGroup"]      = "You are not in a group",
    ["notEnoughMembers"] = "Not enough members in your group",
    ["notLeader"]        = "You are not the leader of the group",
    ["cooldownActive"]   = "Cooldown is active",
    ["noDoors"]          = "You dont have any doors to scrap",
    ["noWheels"]         = "You dont have any wheels to scrap",
    ["noTrunk"]          = "You dont have a trunk to scrap",
    ["noHood"]           = "You dont have a hood to scrap",

    -- Draw Text
    ["chop"]             = "[E] Start Chopping",
    ["remove"]           = "[E] Remove ",
    ["destroy"]          = "[E] Destroy Car ",
    ["reqjob"]           = "[E] Request Vehicle Information",
    ["Trunk"]            = "Trunk",
    ["Hood"]             = "Hood",
    ...
    ["Door1"]            = "Unscrewing the bolts",
    ["Door2"]            = "Hinges are coming off",
    ["crushing"]         = "Sending the car for destruction",
    ["searching"]        = "Searching the trunk",

    ["chopwheel"]        = "Cutting the wheel",
    ["chopdoor"]         = "Cutting the door",
    ["choptrunk"]        = "Cutting the trunk",
    ["chophood"]         = "Cutting the hood",

    -- Others
    ["failedMinigame"]   = "You failed :/",
    ["interactMessage"]  = "Hack Keyfob",
    ["chopParts"]        = "Chop Down Parts",
    ["startJob"]         = "Start Job",
    ["accessShop"]       = "Access Shop",
    ["foundItem"]        = "You found %s %s in the trunk",

    -- Context menu
    ["chopTitle"]        = "Chopping Down Parts",
    ["chopDoor"]         = "Door",
    ["chopWheel"]        = "Wheel",
    ["chopTrunk"]        = "Trunk",
    ["chopHood"]         = "Hood",
    ...
    -- Job status
    ["jobBossName"]      = "Pencho The Chopper",
    ["jobUseScanner"]    = "Use the digital scanner to find signal for the keys",
    ["jobPlate"]         = "Plate:",
    ["jobPlateNotAvai"]  = "Not available",
    ["jobUseScanner2"]   = "Use the digital scanner (LEADER MUST USE) to find signal for the keys",
    ["jobLocation"]      = "Go to the location for the chopping",
    ["jobChopdown"]      = "Chop down the vehicle",
}
