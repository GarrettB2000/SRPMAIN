...
local qboxHas = GetResourceState('qbx_core') == 'started'
local qbHas = GetResourceState('qb-core') == 'started'
local l2sHas = GetResourceState('l2s-core') == 'started'

Config.Framework = esxHas and 'esx' or qboxHas and 'qb' or l2sHas and 'qb' or qbHas and 'qb' or 'standalone' -- You can change to 'qb', 'esx', 'standalone'
...
local function getInventory()
    ...
    local tgiannInvHas = GetResourceState('tgiann-inventory') == 'started'
    if qsInvHas then
        return 'qs-inventory'
...
Config.UniquePhone = getInventory() ~= 'ox_inventory' and Config.Framework ~= 'qb-core'
Config.Inventory = (Config.Framework == 'qb-core' and 'ox_inventory' or getInventory())
...
Config.MailDomain = '@srp.com' -- Choose the email domain
...
Config.Market.Management.Deposit = false
Config.Market.Management.Withdraw = false
Config.Market.Management.Hire = false
Config.Market.Management.Fire = false
Config.Market.Management.Promote = false
...
Config.StoreApps = {
    ...
    },
    {
        ...
        label = 'Racing',
        job = false,                -- or { 'ambulance' }
        blockedJobs = { 'ambulance', 'realestate' , 'styles', 'hayes', 'tunershop', 'bennys', 'lscustoms', 'bestbuds', 'catcafe', 'vanillaunicorn', 'tequilala', 'pizzathis', 'burgershot', 'bahamamamas', 'beanmachine', 'popsdiner', 'administration', 'bus', 'trucker', 'tow', 'taxi', 'garbage' }, -- or { 'ambulance' }
        timeout = 21000,
        creator = 'Insane Team',
        category = 'Other',
        isGame = false,
