...
------------------------------
---------- [STRINGS] ----------
Config.inventoryImagesDirectoryPath = "resources/[inventory]/ox_inventory/html/images/" -- Image directory path to your inventory script so that images can be saved to it when you make new items.
...
Config.BusinessCommission = 0.80 -- (%) 30 % is the commision that goes to the business of each register sale
Config.BillerCommission = 0.10 -- (%) 5 % is the commision that goes to the worker who makes the sale at the register (they also get the Config.WorkersCommission so in total 15 %)
