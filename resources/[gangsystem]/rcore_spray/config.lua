Config = {
    ...
    Text = {
        ...
        SPRAY_ERRORS = {
            NOT_FLAT = 'NOT FLAT ENOUGH.',
            TOO_FAR = 'YOU ARE TO FAR AWAY.',
            INVALID_SURFACE = 'INVALID SURFACE.',
            AIM = 'AIM AT A FLAT SURFACE.',
        },
        NO_SPRAY_NEARBY = 'NO SPRAY NEARBY',
        NEED_SPRAY = 'NEED SPRAY',
        WORD_LONG = 'WORDS ARE TO LONG',
        USAGE = 'Command: /spray <spray name>',
